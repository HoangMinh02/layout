        ...
        <nav class="user-dashboard-menu">
          <ul>
            ...
            <li class="menu-btn menu-stick-right">
              <a class="btn btns-bordered-alt text-upper" href="new-ticket.html"
                >Đăng xuất</a
              >
            </li>
          </ul>
            ...
            <div class="sm-col-12" data-inview-showup="showup-translate-right">
              <div class="field-group field-type-image">
                ...
                <div class="field-wrap">
                  ...
                  />
                  <span class="field-addon-btn"
                    ><a class="field-file-btn text-upper btn" href="#"
                      >Choose file</a
                    ></span
                  >
                  ...
                  <div class="file-preview">
                    <div class="file-preview-image">
                      <img
                        src="assets/images/outsource/user-small.jpg"
                        alt=""
                      />
                    </div>
